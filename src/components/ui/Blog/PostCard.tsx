...
const PostCard: React.FC<PostCardProps> = ({ post }) => {
    ...
    return (
        <div className="group relative flex items-stretch py-1">
            {/* Animated left border */}
            <div
                className="w-px mr-5 flex-shrink-0 transition-all duration-500 opacity-0 group-hover:opacity-100"
                style={{
            ...
            {/* Card content */}
            <div className="flex-1 py-5 border-b border-white/5 group-hover:border-white/10 transition-colors duration-300">
                {/* Title */}
                ...
                {/* Description */}
                {!!post.description && (
                    <p className="text-sm leading-relaxed text-gray-400 group-hover:text-gray-300 transition-colors duration-200 mb-4">
