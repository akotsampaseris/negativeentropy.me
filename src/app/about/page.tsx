                ...
                <div className="p-4">
                    <ol className="relative border-s border-gray-600">
                        <li className="mb-10 ms-6">
                            ...
                            <h5 className="flex items-center mb-1 text-lg font-semibold text-white">Being Born</h5>
                        ...
                        <li className="mb-10 ms-6">
                            ...
                            <h5 className="flex items-center mb-1 text-lg font-semibold text-white">Move to Athens</h5>
                            <time className="flex items-center gap-2 mb-2 text-sm font-normal leading-none text-green-600">
                                <div className="flex items-center gap-1">
                        ...
                        <li className="mb-10 ms-6">
                            ...
                            <h5 className="flex items-center mb-1 text-lg font-semibold text-white">Life-changing decision #1: Go abroad to study Physics</h5>
                            <time className="flex items-center gap-2 mb-2 text-sm font-normal leading-none text-green-600">
                                <div className="flex items-center gap-1">
                        ...
                        <li className="mb-10 ms-6">
                            ...
                            <h5 className="flex items-center mb-1 text-lg font-semibold text-white">The best year of my life</h5>
                            <time className="flex items-center gap-2 mb-2 text-sm font-normal leading-none text-green-600">
                                <div className="flex items-center gap-1">
                            ...
                            <p className="mb-4 text-base font-normal">
                                ...
                                , which was as fascinating as it was mind-bending. By the end of it, I’d finished at the top of the class and even picked up an award, which still
                                feels slightly surreal. It was the hardest I’d ever worked, and the most alive I’d ever felt.
                            </p>
                        </li>
                        <li className="mb-10 ms-6">
                            <span className="absolute flex items-center justify-center w-6 h-6 rounded-full -start-3 ring-8 ring-gray-900 bg-green-900">
                        ...
                        <li className="mb-10 ms-6">
                            ...
                            <h5 className="flex items-center mb-1 text-lg font-semibold text-white">Covid 19: A blur</h5>
                            <time className="flex items-center gap-2 mb-2 text-sm font-normal leading-none text-green-600">
                                <div className="flex items-center gap-1">
                            ...
                            <p className="mb-4 text-base font-normal">
                                ...
                                most impactful one yet — feels like it’s just around the corner.
                            </p>
                        </li>
                        <li className="mb-10 ms-6">
                            <span className="absolute flex items-center justify-center w-6 h-6 rounded-full -start-3 ring-8 ring-gray-900 bg-green-900">
                            ...
                            <h5 className="flex items-center mb-1 text-lg font-semibold text-white">Focus on Open-Source</h5>
                            <time className="flex items-center gap-2 mb-2 text-sm font-normal leading-none text-green-600">
                                <div className="flex items-center gap-1">
