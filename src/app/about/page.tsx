  ...
  return (
    <div className="w-fit space-y-4">
      <div>
        ...
        <p>This isn’t a full autobiography — just a look at the kind of stuff I like to explore, build, and occasionally overthink. Mostly driven by curiosity and a habit of going deep when something grabs my attention.</p>
      </div>
      <div>
        ...
        <div className="p-4">
          <ol className="relative border-s border-gray-600">
            <li className="mb-10 ms-6">
              ...
              <h5 className="flex items-center mb-1 text-lg font-semibold text-white">
                Being Born
              </h5>
            ...
            <li className="mb-10 ms-6">
              ...
              <p className="mb-4 text-base font-normal">
              Moving abroad to study physics felt like a big decision at the time — and to be fair, it was. Between learning how to make tea properly and deciphering <strong>quantum mechanics</strong>, I somehow found a rythm. By my second year, I was already getting involved in <strong>professional research</strong> with two of my professors, which probably says more about how obsessed I was than how prepared I felt.
              </p>
            </li>
            <li className="mb-10 ms-6">
              <span className="absolute flex items-center justify-center w-6 h-6 rounded-full -start-3 ring-8 ring-gray-900 bg-green-900">
            ...
            <li className="mb-10 ms-6">
              ...
              <p className="mb-4 text-base font-normal">
                After years of building things behind closed doors, I’ve decided my next chapter belongs to the <strong>open internet</strong>. I want to solve real problems — the kind that matter to developers, to technology, and maybe even to society. <strong>Open source</strong> is where I can do that while leaving a mark that others can build on. Whether it’s tools, infrastructure, or ideas, I want my work to be visible, useful, and out in the wild. That’s where I’m headed: public by default, driven by curiosity, and focused on impact.
              </p>
            </li>
          </ol>
        </div>
